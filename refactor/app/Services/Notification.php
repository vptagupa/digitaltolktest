...
Trait Notification
{
    ...
    public function sendSMSNotificationToTranslator($job)
    {
        ...
        $duration = GlobalHelper::convertToHoursMins($job->duration);
        $jobId = $job->id;
    ...
    public function sendNotificationTranslator($job, $data = [], $exclude_user_id)
    {
        ...
        BookingServices::sendPushNotificationToSpecificUsers($translator_array, $job->id, $data, $msg_text, false);       // send new booking push to suitable translators(not delay)
        BookingServices::sendPushNotificationToSpecificUsers($delpay_translator_array, $job->id, $data, $msg_text, true); // send new booking push to suitable translators(need to delay)
    }
    ...
    public function sendExpiredNotification($job, $user)
    {
        ...
        if ($this->isNeedToSendPush($user->id)) {
            $users_array = array($user);
            $this->sendNotificationTranslatorsendPushNotificationToSpecificUsers($users_array, $job->id, $data, $msg_text, $this->isNeedToDelayPush($user->id));
        }
    }
    ...
    public function sendNotificationByAdminCancelJob($job_id)
    {
        ...
        $this->sendNotificationTranslatorsendNotificationTranslator($job, $data, '*');   // send Push all sutiable translators
    }
